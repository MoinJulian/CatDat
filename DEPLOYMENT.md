...
The database is hosted on [Turso](https://turso.tech). The command `pnpm db:create:remote` creates the Turso database from the database as defined in the [/database](/database/) folder. See [database.md](/DATABASE.md) for details on this command.
